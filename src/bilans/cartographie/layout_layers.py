...
from bilans.cartographie.layer_resolver import infer_layer_role

if TYPE_CHECKING:
    from bilans.cartographie.config_cartes_model import LayerSymbologyConfig, ProfileConfig
...
def build_layer_configs_from_names(
    ...
    from bilans.cartographie.config_cartes_model import LayerSymbologyConfig
