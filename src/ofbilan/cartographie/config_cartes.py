...
DEFAULT_PROFILES: Dict[str, ProfileConfig] = {
    ...
    'pnf': ProfileConfig(
        id='pnf',
        title="Bilan PNF — Activité du service dans le Parc — Côte-d'Or",
        layout_name="modele_mise_en_page_carto_bilans",
        output_filename='carte_pnf.png',
        date_deb='2025-01-01',
        date_fin='2026-06-18',
        layers={
            'pochoir_aoa': LayerSymbologyConfig(
                layer_name='pochoir_aoa',
                legend_label='Aire d\'adhésion PNF',
                filter_type='',
                geometry_mode='polygon_fill',
                renderer_type='graduated',
                field='',
            ...
            'coeur_parc': LayerSymbologyConfig(
                layer_name='coeur_parc',
                legend_label='Cœur du parc',
                filter_type='',
                geometry_mode='polygon_fill',
                renderer_type='graduated',
                field='',
            ...
            'point_ctrl_20260205_wgs84': LayerSymbologyConfig(
                layer_name='point_ctrl_20260205_wgs84',
                legend_label='Contrôles (localisations)',
        ...
        title_main="Activité de contrôle - PNF",
        subtitle='',
        layout_title_item_id='titre_principal',
        layout_subtitle_item_id='sous_titre',
    ),
