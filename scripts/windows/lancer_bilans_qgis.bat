...
REM Lancer python -m ofbilan avec le Python QGIS / OSGeo4W (PyQGIS pour cartes adaptatives).
REM Sans argument : saisie interactive deleguee entierement a python -m ofbilan.
REM Detection calquee sur src\ofbilan\cartographie\lancer_production_cartographique.bat
