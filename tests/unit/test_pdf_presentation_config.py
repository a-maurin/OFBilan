...
from core.common.pdf_usagers_domaine_table import build_usagers_x_domaine_pdf_rows
...
def test_resolve_sec34_render_order_defaults_usagers_before_procedures() -> None:
    from core.common.pdf_presentation_config import resolve_sec34_render_order
